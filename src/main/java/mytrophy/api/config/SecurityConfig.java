...
import mytrophy.api.member.service.CustomeOAuth2UserService;
...
public class SecurityConfig {
    ...
    private final CustomeOAuth2UserService oAuth2UserService;
        ...
        http
               ...
               // .cors(AbstractHttpConfigurer::disable) // cors 비활성화 -> 프론트와 연결 시 따로 설정 필요
                ...
                .authorizeHttpRequests((authorizeRequests) ->
                        authorizeRequests
                                .requestMatchers("/", "/login","/home", "/api/signup").permitAll()
